...
void output()
{
	...
	Serial.print(" RH: ");Serial.print(sensorData[3]);
	...
	// # ISWALL #
	Serial.print("Walls:");
	Serial.print(" F: ");Serial.print(wallExists(FRONT, &sensorData[0]));
	Serial.print(" R: ");Serial.print(wallExists(RIGHT, &sensorData[0]));
	Serial.print(" L: ");Serial.print(wallExists(LEFT, &sensorData[0]));
	Serial.print(" B: ");Serial.println(wallExists(BACK, &sensorData[0]));
}
